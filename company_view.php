                    ...
                    >
					  ...
					  ?>
                        <tr>
                          ...
                          <td><?php echo $row['c_eligiblity'];?></td>
						  <?php if($status=='<button type="button" class="btn btn-success">Active</button>'){
							  ?>
							   <td><a href="<?php echo $row['c_link'];?>" target="_blank"><?php echo $row['c_link'];?></a></td>
							 
						  <?php }else{?>
                          <td><?php echo $row['c_link'];?></td>
						  <?php } ?>
                          <td><?php echo $row['c_studentselect'];?></td>
